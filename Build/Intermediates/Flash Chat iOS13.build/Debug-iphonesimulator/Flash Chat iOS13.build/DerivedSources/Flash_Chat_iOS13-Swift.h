...
#ifndef FLASH_CHAT_IOS13_SWIFT_H
#define FLASH_CHAT_IOS13_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Flash_Chat_iOS13",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16Flash_Chat_iOS1311AppDelegate")
...
@interface ChatViewController (SWIFT_EXTENSION(Flash_Chat_iOS13)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC16Flash_Chat_iOS1319LoginViewController")
...
SWIFT_CLASS("_TtC16Flash_Chat_iOS1311MessageCell")
@interface MessageCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified messageLabel;
...
SWIFT_CLASS("_TtC16Flash_Chat_iOS1322RegisterViewController")
...
SWIFT_CLASS("_TtC16Flash_Chat_iOS1313SceneDelegate")
...
SWIFT_CLASS("_TtC16Flash_Chat_iOS1321WelcomeViewController")
@interface WelcomeViewController : UIViewController
@property (nonatomic, weak) IBOutlet CLTypingLabel * _Null_unspecified titleLabel;
- (void)viewDidLoad;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
